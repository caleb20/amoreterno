              ...
              <div className="text-center text-white px-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a
                    ...
                    className="bg-primary text-white px-8 py-4 rounded-lg font-poppins font-bold hover:bg-primary-600 transition-all duration-300 inline-flex items-center justify-center space-x-2 shadow-lg transform hover:scale-105"
                  >
                  ...
                  <button
                    ...
                    className="bg-secondary text-gray-800 px-8 py-4 rounded-lg font-poppins font-bold hover:bg-yellow-300 transition-all duration-300 shadow-lg transform hover:scale-105"
                  >
                    Ver Catálogo
                  </button>
                </div>
